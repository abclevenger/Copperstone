...
const checklistItems: ChecklistItem[] = [
  ...
  {
    id: "messaging",
    title: "Business Messaging & Communications",
    description:
      "Engage customers with SMS marketing, email automation, live chat, unified messaging, and review management through trusted platform partners.",
    icon: (
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  },
  {
    ...
    description:
      "Get expert help launching, scaling, or managing a franchise — from compliance and FDD review to multi-location operations and territory planning.",
    icon: (
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  },
  {
    ...
    description:
      "Develop stronger leaders with executive coaching, management training, team workshops, and professional development programs.",
    icon: (
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
