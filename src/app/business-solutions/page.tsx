...
export const metadata: Metadata = {
  ...
  description:
    "Copperstone Executive Suites offers office space, virtual offices, meeting rooms, and business growth solutions through trusted partners — phone systems, website design, SEO, cybersecurity, IT, and consulting in Land O' Lakes and South Tampa.",
